...
if(is_ajax())
{
	...
	if(isset($_POST['change_factor']))
	{
		try
		{
			$gallery->set_factor($_POST['set_factor'], $_POST['currency_code']);
		}
		catch(Exception $e)
		{
...
<div id="cur_form" data-action="<?php echo $loc_script;?>">
    <span>Код валюты:</span>&nbsp;
    <input type="text" name="currency_code" id="currency_code" value="BYN" />&nbsp;
    <span>Курс к доллару:</span>&nbsp;
    <input type="text" name="cur_factor" id="cur_factor" value="<?php echo $gallery->cur_factor;?>" />&nbsp;
